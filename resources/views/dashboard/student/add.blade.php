            ...
            <nav class="breadcrumbs">
                <div class="container">
                    <ol>
                        ...
                        <li class="current">Add Student</li>
                    </ol>
                </div>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3 needs-validation" novalidate method="post" action={{ route('addStudent') }}
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="student_name" required value="{{old('student_name')}}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <label for="studentEmail" class="col-sm-2 col-lg-4 col-form-label">Student Email</label>
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" name="student_email" required value="{{old('student_email')}}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <label for="studentPassword" class="col-sm-2 col-lg-4 col-form-label">Student Password</label>
                                <div class="col-sm-10">
                                    <input type="password" class="form-control" name="student_password" required value="{{old('student_password')}}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <label for="student_about" class="col-sm-2 col-lg-4 col-form-label">About Student</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" style="height: 100px" name="student_about" required>{{old('student_about')}}</textarea>
                                </div>
                            </div>
